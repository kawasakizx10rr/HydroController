/*
  ...
  Created on the 21/03/2022, All rights are reserved and none of the software or text
  ...
  V4.5.0
  Sketch uses 209072 bytes (82%) of program storage space. Maximum is 253952 bytes.
  Global variables use 5517 bytes (67%) of dynamic memory, leaving 2675 bytes for local variables. Maximum is 8192 bytes.

  V4.5.1
  Sketch uses 186074 bytes (73%) of program storage space. Maximum is 253952 bytes.
  Global variables use 4766 bytes (58%) of dynamic memory, leaving 3426 bytes for local variables. Maximum is 8192 bytes.
*/
...
uint16_t lastLeftTouch = 0;
uint16_t lastRightTouch = 0;
uint16_t lastDownTouch = 0;
uint16_t lastUpTouch = 0;
...
const char versionNumber[] = "4.5.2"; // do not adjust !
