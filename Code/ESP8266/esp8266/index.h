...
let lightOffTimeHour = 0;
let lightOffTimeMin = 0;
let lightOnDuration = 0;
let lightOffDuration = 0;
let lightState = 0;
let lightMode = 0;
let auxRelayOneOnTimeHour = 0;
let auxRelayOneOnTimeMin = 0;
let auxRelayOneOffTimeHour = 0;
let auxRelayOneOffTimeMin = 0;
let auxRelayOneOnDuration = 0;
let auxRelayOneOffDuration = 0;
let auxRelayOneState = 0;
let auxRelayOneMode = 0;
let auxRelayTwoOnTimeHour = 0;
let auxRelayTwoOnTimeMin = 0;
let auxRelayTwoOffTimeHour = 0;
let auxRelayTwoOffTimeMin = 0;
let auxRelayTwoOnDuration = 0;
let auxRelayTwoOffDuration = 0;
let auxRelayTwoState = 0;
let auxRelayTwoMode = 0;
// sensors
let ecSensor = 0;
let tdsSensor = 0;
let phSensor = 0;
...
<img id="light_blue" src="data:image/png;base64,
"alt="light_blue"style="display:none;"/>
  ...
  <div id="tftDisplay">
    <div id="topMenu">
      ...
      <div class="topMenuButtonDiv" id="button11" onclick='setPage("11", true)' style="margin-right:0.3%;">
        <img id="button11_Img" alt="Arduino Components" style="width:90%;height:92%;padding-left:5%;padding-top:2.5%;" />
      </div>
	...
	<div id="page11" style="display:none;width:100%;height:100%;">
        <div id="topbar" style="display:block;width:100%;">
          <div class="slideIcon" style="float:left;padding-left:10px;padding-right:2px;">
            <img id="timerSlideIcon1"  style="width:100%;height:100%;" />
          </div>
          <div class="slideIcon" style="float:left;padding-right:2px;">
            <img id="timerSlideIcon2" style="width:100%;height:100%;" />
          </div>
          <div class="slideIcon" style="float:left;padding-right:2px;">
            <img id="timerSlideIcon3" style="width:100%;height:100%;" />
          </div>
          <div class="slideIcon" style="float:left;padding-right:2px;">
            <img id="timerSlideIcon4" style="width:100%;height:100%;" />
          </div>
        </div>
        <div id="leftSlideArrow" onclick="timerPageSlider(-1)">
          <img class="leftSlideArrowIcon"  alt="right scroll" style="width:100%;height:100%;cursor:pointer;" />
        </div>
        <div id="rightSlideArrow" onclick="timerPageSlider(1)">
          <img class="rightSlideArrowIcon"  alt="right scroll" style="width:100%;height:100%;cursor:pointer;" />
        </div>
        <div style="width:94%;height:100%;float:left;">
		
          <div id="timerPage1" style="display:block;width:100%;height:100%;float:left;">
            <div style="display:block;width:100%;height:20%;float:left;">
              <b><p style="margin:0px;text-align:center;" class="p3text">Light timer</p></b>
            </div>
            <div style="display:block;width:100%;height:20%;float:left;">
              <div style="display:block;width:50%;height:100%;float:left;">
                <b><p style="margin:0px;text-align:center;" class="p3text">On time</p></b>
              </div>
              <div style="display:block;width:50%;height:100%;float:left;">
                <b><p style="margin:0px;text-align:center;" class="p3text">Off time</p></b>
              </div>
            </div>
            <div style="display:block;width:50%;height:60%;float:left;">
              <div style="display:block;width:100%;height:50%;float:left;">
                <center>
                  <b><p id="lightOnTime" class="p5text" style="margin:0px;display:inline;">-</p></b>
				  <b><p id="lightOnHrs" class="p3text" style="margin:0px;display:none;">hrs</p></b>
				  <b><p id="lightOnTime2" class="p5text" style="margin:0px;display:none;">-</p></b>
				  <b><p id="lightOnMins" class="p3text" style="margin:0px;display:none;">mins</p></b>
                </center>
              </div>
              <div style="display:block;width:100%;height:50%;float:left;">
                <div style="display:block;width:15%;height:50%;float:left;"></div>
                <div style="display:block;width:25%;height:55%;float:left;">
                  <img class="ldbutt" alt="up arrow" onclick="adjustLightOnTime(-1)" style="float:right;"/>
                </div>
                <div style="display:block;width:20%;height:50%;float:left;"></div>
                <div style="display:block;width:25%;height:55%;float:left;">
                  <img class="lubutt" alt="down arrow" onclick="adjustLightOnTime(1)" style="float:left;"/>
                </div>
                <div style="display:block;width:15%;height:50%;float:left;"></div>
              </div>
            </div>
            <div style="display:block;width:50%;height:60%;float:left;">
              <div style="display:block;width:100%;height:50%;float:left;">
                <center>
                  <b><p id="lightOffTime" class="p5text" style="margin:0px;display:inline;">-</p></b>
				  <b><p id="lightOffHrs" class="p3text" style="margin:0px;display:none;">hrs</p></b>
				  <b><p id="lightOffTime2" class="p5text" style="margin:0px;display:none;">-</p></b>
				  <b><p id="lightOffMins" class="p3text" style="margin:0px;display:none;">mins</p></b>
                </center>
              </div>
              <div style="display:block;width:100%;height:50%;float:left;">
                <div style="display:block;width:15%;height:50%;float:left;"></div>
                <div style="display:block;width:25%;height:55%;float:left;">
                  <img class="ldbutt" alt="up arrow" onclick="adjustLightOffTime(-1)" style="float:right;"/>
                </div>
                <div style="display:block;width:20%;height:50%;float:left;"></div>
                <div style="display:block;width:25%;height:55%;float:left;">
                  <img class="lubutt" alt="down arrow" onclick="adjustLightOffTime(1)" style="float:left;"/>
                </div>
                <div style="display:block;width:15%;height:50%;float:left;"></div>
              </div>
            </div>
          ...
          <div id="timerPage2" style="display:none;width:100%;height:100%;float:left;">
            <div style="display:block;width:100%;height:20%;float:left;">
              <b><p style="margin:0px;text-align:center;" class="p3text">Aux relay 1 timer</p> </b>
            </div>
            <div style="display:block;width:100%;height:20%;float:left;">
              <div style="display:block;width:50%;height:100%;float:left;">
                <b><p style="margin:0px;text-align:center;" class="p3text">On time</p></b>
            ...
            <div style="display:block;width:50%;height:60%;float:left;">
              <div style="display:block;width:100%;height:50%;float:left;">
                <center>
                  <b><p id="auxRelayOneOnTime" class="p5text" style="margin:0px;display:inline;">-</p></b>
				  <b><p id="auxRelayOneOnHrs" class="p3text" style="margin:0px;display:none;">hrs</p></b>
				  <b><p id="auxRelayOneOnTime2" class="p5text" style="margin:0px;display:none;">-</p></b>
				  <b><p id="auxRelayOneOnMins" class="p3text" style="margin:0px;display:none;">mins</p></b>
                </center>
              </div>
              <div style="display:block;width:100%;height:50%;float:left;">
                <div style="display:block;width:15%;height:50%;float:left;"></div>
                <div style="display:block;width:25%;height:55%;float:left;">
                  <img class="ldbutt" alt="up arrow" onclick="adjustAuxOneOnTime(-1)" style="float:right;"/>
                </div>
                <div style="display:block;width:20%;height:50%;float:left;"></div>
                <div style="display:block;width:25%;height:55%;float:left;">
                  <img class="lubutt" alt="down arrow" onclick="adjustAuxOneOnTime(1)" style="float:left;"/>
                </div>
                <div style="display:block;width:15%;height:50%;float:left;"></div>
              </div>
            </div>
            <div style="display:block;width:50%;height:60%;float:left;">
              <div style="display:block;width:100%;height:50%;float:left;">
                <center>
                  <b><p id="auxRelayOneOffTime" class="p5text" style="margin:0px;display:inline;">-</p></b>
				  <b><p id="auxRelayOneOffHrs" class="p3text" style="margin:0px;display:none;">hrs</p></b>
				  <b><p id="auxRelayOneOffTime2" class="p5text" style="margin:0px;display:none;">-</p></b>
				  <b><p id="auxRelayOneOffMins" class="p3text" style="margin:0px;display:none;">mins</p></b>
                </center>
              </div>
              <div style="display:block;width:100%;height:50%;float:left;">
                <div style="display:block;width:15%;height:50%;float:left;"></div>
                <div style="display:block;width:25%;height:55%;float:left;">
                  <img class="ldbutt" alt="up arrow" onclick="adjustAuxOneOffTime(-1)" style="float:right;"/>
                </div>
                <div style="display:block;width:20%;height:50%;float:left;"></div>
                <div style="display:block;width:25%;height:55%;float:left;">
                  <img class="lubutt" alt="down arrow" onclick="adjustAuxOneOffTime(1)" style="float:left;"/>
                </div>
                <div style="display:block;width:15%;height:50%;float:left;"></div>
              </div>
            </div>
          ...
          <div id="timerPage3" style="display:none;width:100%;height:100%;float:left;">
            <div style="display:block;width:100%;height:20%;float:left;">
              <b><p style="margin:0px;text-align:center;" class="p3text">Aux relay 2 timer</p></b>
            </div>
            <div style="display:block;width:100%;height:20%;float:left;">
              <div style="display:block;width:50%;height:100%;float:left;">
                <b><p style="margin:0px;text-align:center;" class="p3text">On time</p></b>
            ...
            <div style="display:block;width:50%;height:60%;float:left;">
			  <div style="display:block;width:100%;height:50%;float:left;">
			    <center>
			      <b><p id="auxRelayTwoOnTime" class="p5text" style="margin:0px;display:inline;">-</p></b>
				  <b><p id="auxRelayTwoOnHrs" class="p3text" style="margin:0px;display:none;">hrs</p></b>
				  <b><p id="auxRelayTwoOnTime2" class="p5text" style="margin:0px;display:none;">-</p></b>
				  <b><p id="auxRelayTwoOnMins" class="p3text" style="margin:0px;display:none;">mins</p></b>
			    </center>
			  </div>
              <div style="display:block;width:100%;height:50%;float:left;">
                <div style="display:block;width:15%;height:50%;float:left;"></div>
                <div style="display:block;width:25%;height:55%;float:left;">
                  <img class="ldbutt" alt="up arrow" onclick="adjustAuxTwoOnTime(-0.1)" style="float:right;"/>
                </div>
                <div style="display:block;width:20%;height:50%;float:left;"></div>
                <div style="display:block;width:25%;height:55%;float:left;">
                  <img class="lubutt" alt="down arrow" onclick="adjustAuxTwoOnTime(0.1)" style="float:left;"/>
                </div>
                <div style="display:block;width:15%;height:50%;float:left;"></div>
              </div>
            </div>          
            <div style="display:block;width:50%;height:60%;float:left;">
			  <div style="display:block;width:100%;height:50%;float:left;">
			    <center>
			      <b><p id="auxRelayTwoOffTime" class="p5text" style="margin:0px;display:inline;">-</p></b>
				  <b><p id="auxRelayTwoOffHrs" class="p3text" style="margin:0px;display:none;">hrs</p></b>
				  <b><p id="auxRelayTwoOffTime2" class="p5text" style="margin:0px;display:none;">-</p></b>
				  <b><p id="auxRelayTwoOffMins" class="p3text" style="margin:0px;display:none;">mins</p></b>
			    </center>
			  </div>
              <div style="display:block;width:100%;height:50%;float:left;">                       
                <div style="display:block;width:15%;height:50%;float:left;"></div>
                <div style="display:block;width:25%;height:55%;float:left;">
                  <img class="ldbutt" alt="up arrow" onclick="adjustAuxTwoOffTime(-0.01)" style="float:right;"/>
                </div>
                <div style="display:block;width:20%;height:50%;float:left;"></div>
                <div style="display:block;width:25%;height:55%;float:left;">
                  <img class="lubutt" alt="down arrow" onclick="adjustAuxTwoOffTime(0.1)" style="float:left;"/>
                </div>
                <div style="display:block;width:15%;height:50%;float:left;"></div>            
              </div>
            </div>                
          ...
          <div id="timerPage4" style="display:none;width:100%;height:100%;float:left;">
            <div style="display:block;width:100%;height:20%;float:left;">
              <b><p style="margin:0px;text-align:center;" class="p3text">Timer settings</p></b>
            </div>
            <div style="display:block;width:100%;height:70%;float:left;">
			
              <div style="display:block;width:100%;height:16.5%;float:left;">
                <div style="display:block;width:60%;height:100%;float:left;">
                  <b><p style="margin:0px;text-align:left;padding-left:5%;" class="p3text">Light On/Off/Auto</p></b>
                </div>
                <div style="display:block;width:40%;height:100%;float:left;">
                  <div style="display:block;width:30%;height:100%;float:left;"></div>
                  <div style="display:block;width:50%;height:100%;float:right;">
                    <div style="display:block;width:100%;height:70%;float:right;">
					  <div id="lightOff" style="display:block;width:31%;height:100%;float:left;background:red;border-radius:8px 0px 0px 8px;border:1px solid;cursor:pointer;" onclick="adjustLightState(2)"></div>
					  <div id="lightAuto" style="display:block;width:31%;height:100%;float:left;background:red;border:1px solid;cursor:pointer;" onclick="adjustLightState(0)"></div>
					  <div id="lightOn" style="display:block;width:31%;height:100%;float:left;background:lime;border-radius:0px 8px 8px 0px;border:1px solid;cursor:pointer;" onclick="adjustLightState(1)"></div>
                    </div>
                  </div>
                  <div style="display:block;width:20%;height:100%;float:left;"></div>
                </div>
              ...
              <div style="display:block;width:100%;height:16.5%;float:left;">
                <div style="display:block;width:60%;height:100%;float:left;">
                  <b><p style="margin:0px;text-align:left;padding-left:5%;" class="p3text">Aux relay 1 On/Off/Auto</p></b>
                </div>
                <div style="display:block;width:40%;height:100%;float:left;">
                  <div style="display:block;width:30%;height:100%;float:left;"></div>
                  <div style="display:block;width:50%;height:100%;float:right;">
                    <div style="display:block;width:100%;height:70%;float:right;">
					  <div id="auxOneOff" style="display:block;width:31%;height:100%;float:left;background:red;border-radius:8px 0px 0px 8px;border:1px solid;cursor:pointer;" onclick="adjustAuxOneState(2)"></div>
					  <div id="auxOneAuto" style="display:block;width:31%;height:100%;float:left;background:red;border:1px solid;cursor:pointer;" onclick="adjustAuxOneState(0)"></div>
					  <div id="auxOneOn" style="display:block;width:31%;height:100%;float:left;background:lime;border-radius:0px 8px 8px 0px;border:1px solid;cursor:pointer;" onclick="adjustAuxOneState(1)"></div>
                    </div>
                  </div>
                  <div style="display:block;width:20%;height:100%;float:left;"></div>
                </div>
              ...
              <div style="display:block;width:100%;height:16.5%;float:left;">
                <div style="display:block;width:60%;height:100%;float:left;">
                  <b><p style="margin:0px;text-align:left;padding-left:5%;" class="p3text">Aux relay 2 On/Off/Auto</p></b>
                </div>
                <div style="display:block;width:40%;height:100%;float:left;">
                  <div style="display:block;width:30%;height:100%;float:left;"></div>
                  <div style="display:block;width:50%;height:100%;float:right;">
                    <div style="display:block;width:100%;height:70%;float:right;">
					  <div id="auxTwoOff" style="display:block;width:31%;height:100%;float:left;background:red;border-radius:8px 0px 0px 8px;border:1px solid;cursor:pointer;" onclick="adjustAuxTwoState(2)"></div>
					  <div id="auxTwoAuto" style="display:block;width:31%;height:100%;float:left;background:red;border:1px solid;cursor:pointer;" onclick="adjustAuxTwoState(0)"></div>
					  <div id="auxTwoOn" style="display:block;width:31%;height:100%;float:left;background:lime;border-radius:0px 8px 8px 0px;border:1px solid;cursor:pointer;" onclick="adjustAuxTwoState(1)"></div>
                    </div>
                  </div>
                  <div style="display:block;width:20%;height:100%;float:left;"></div>
                </div>
              ...
              <div style="display:block;width:100%;height:16.5%;float:left;">
                <div style="display:block;width:60%;height:100%;float:left;">
                  <b><p style="margin:0px;text-align:left;padding-left:5%;" class="p3text">Light mode Cyclic/Timer</p></b>
                </div>
                <div style="display:block;width:40%;height:100%;float:left;">
                  <div style="display:block;width:30%;height:100%;float:left;"></div>
                  <div style="display:block;width:50%;height:100%;float:right;">
                    <div style="display:block;width:100%;height:70%;float:right;">
                      <div
                        id="lightModeRight"
                        class="leftToggle"
                        onclick="adjustLightMode(false)">
                      </div>
                      <div
                        id="lightModeLeft"
                        class="rightToggle"
                        onclick="adjustLightMode(true)">
                      </div>
                    </div>
                  </div>
                  <div style="display:block;width:20%;height:100%;float:left;"></div>
			  ...
			  <div style="display:block;width:100%;height:16.5%;float:left;">
                <div style="display:block;width:60%;height:100%;float:left;">
                  <b><p style="margin:0px;text-align:left;padding-left:5%;" class="p3text">Aux relay 1 mode Cyclic/Timer</p></b>
                </div>
                <div style="display:block;width:40%;height:100%;float:left;">
                  <div style="display:block;width:30%;height:100%;float:left;"></div>
                  <div style="display:block;width:50%;height:100%;float:right;">
                    <div style="display:block;width:100%;height:70%;float:right;">
                      <div
                        id="auxOneModeRight"
                        class="leftToggle"
                        onclick="adjustAuxOneMode(false)">
                      </div>
                      <div
                        id="auxOneModeLeft"
                        class="rightToggle"
                        onclick="adjustAuxOneMode(true)">
                      </div>
                    </div>
                  </div>
                  <div style="display:block;width:20%;height:100%;float:left;"></div>
              ...
              <div style="display:block;width:100%;height:16.5%;float:left;">
                <div style="display:block;width:60%;height:100%;float:left;">
                  <b><p style="margin:0px;text-align:left;padding-left:5%;" class="p3text">Aux relay 2 mode Cyclic/Timer</p></b>
                </div>
                <div style="display:block;width:40%;height:100%;float:left;">
                  <div style="display:block;width:30%;height:100%;float:left;"></div>
                  <div style="display:block;width:50%;height:100%;float:right;">
                    <div style="display:block;width:100%;height:70%;float:right;">
                      <div
                        id="auxTwoModeRight"
                        class="leftToggle"
                        onclick="adjustAuxTwoMode(false)">
                      </div>
                      <div
                        id="auxTwoModeLeft"
                        class="rightToggle"
                        onclick="adjustAuxTwoMode(true)">
                      </div>
                    </div>
                  </div>
                  <div style="display:block;width:20%;height:100%;float:left;"></div>
...
function setPage(pageNumber, refreshValues) {
  ...
  if (pageNumber == 1) {
	...
	setToggleButton(lightMode,"lightMode");      
	if (lightMode == 0) {
		document.getElementById("lightOnHrs").style.display = "inline";
		document.getElementById("lightOnTime2").style.display = "inline";
		document.getElementById("lightOnMins").style.display = "inline";
		document.getElementById("lightOffHrs").style.display = "inline";
		document.getElementById("lightOffTime2").style.display = "inline";
		document.getElementById("lightOffMins").style.display = "inline";
	}
	else {
		document.getElementById("lightOnHrs").style.display = "none";
		document.getElementById("lightOnTime2").style.display = "none";
		document.getElementById("lightOnMins").style.display = "none";
		document.getElementById("lightOffHrs").style.display = "none";
		document.getElementById("lightOffTime2").style.display = "none";
		document.getElementById("lightOffMins").style.display = "none";
	}
	adjustLightOnTime(null);
    adjustLightOffTime(null);
    if (lightState == 0) {
	...
	//setToggleButton(auxRelayOneMode,"auxRelayOneMode");      
	if (auxRelayOneMode == 0) {
		document.getElementById("auxRelayOneOnHrs").style.display = "inline";
		document.getElementById("auxRelayOneOnTime2").style.display = "inline";
		document.getElementById("auxRelayOneOnMins").style.display = "inline";
		document.getElementById("auxRelayOneOffHrs").style.display = "inline";
		document.getElementById("auxRelayOneOffTime2").style.display = "inline";
		document.getElementById("auxRelayOneOffMins").style.display = "inline";
	}
	else {
		document.getElementById("auxRelayOneOnHrs").style.display = "none";
		document.getElementById("auxRelayOneOnTime2").style.display = "none";
		document.getElementById("auxRelayOneOnMins").style.display = "none";
		document.getElementById("auxRelayOneOffHrs").style.display = "none";
		document.getElementById("auxRelayOneOffTime2").style.display = "none";
		document.getElementById("auxRelayOneOffMins").style.display = "none";
	}
	adjustAuxOneOnTime(null);
    adjustAuxOneOffTime(null);
	if (auxRelayOneState == 0) {
      document.getElementById("auxOneOn").style.backgroundColor = "lightgrey";
      document.getElementById("auxOneAuto").style.backgroundColor = "lime";
      document.getElementById("auxOneOff").style.backgroundColor = "lightgrey";
    }
    else if (auxRelayOneState == 1) {
      document.getElementById("auxOneOn").style.backgroundColor = "lime";
      document.getElementById("auxOneAuto").style.backgroundColor = "lightgrey";
      document.getElementById("auxOneOff").style.backgroundColor = "lightgrey";
    }
    else if (auxRelayOneState == 2) {
      document.getElementById("auxOneOn").style.backgroundColor = "lightgrey";
      document.getElementById("auxOneAuto").style.backgroundColor = "lightgrey";
	...
	if (auxRelayTwoMode == 0) {
		...
		document.getElementById("auxRelayTwoOnTime2").style.display = "inline";
		document.getElementById("auxRelayTwoOnMins").style.display = "inline";
		document.getElementById("auxRelayTwoOffHrs").style.display = "inline";
		document.getElementById("auxRelayTwoOffTime2").style.display = "inline";
		document.getElementById("auxRelayTwoOffMins").style.display = "inline";
	}
	else {
		document.getElementById("auxRelayTwoOnHrs").style.display = "none";
		document.getElementById("auxRelayTwoOnTime2").style.display = "none";
		document.getElementById("auxRelayTwoOnMins").style.display = "none";
		document.getElementById("auxRelayTwoOffHrs").style.display = "none";
		document.getElementById("auxRelayTwoOffTime2").style.display = "none";
		document.getElementById("auxRelayTwoOffMins").style.display = "none";
	}
	adjustAuxTwoOnTime(null);
    adjustAuxTwoOffTime(null);
	if (auxRelayTwoState == 0) {
      document.getElementById("auxTwoOn").style.backgroundColor = "lightgrey";
      document.getElementById("auxTwoAuto").style.backgroundColor = "lime";
      document.getElementById("auxTwoOff").style.backgroundColor = "lightgrey";
    }
    else if (auxRelayTwoState == 1) {
      document.getElementById("auxTwoOn").style.backgroundColor = "lime";
      document.getElementById("auxTwoAuto").style.backgroundColor = "lightgrey";
      document.getElementById("auxTwoOff").style.backgroundColor = "lightgrey";
    }
    else if (auxRelayTwoState == 2) {
      document.getElementById("auxTwoOn").style.backgroundColor = "lightgrey";
      document.getElementById("auxTwoAuto").style.backgroundColor = "lightgrey";
...
function timerPageSlider(inc) {
  if (inc < 0) {
    if (timerPageScrollPosition > 0) timerPageScrollPosition--;
    else timerPageScrollPosition = 3;
  } 
  else if (inc > 0) {
...
function adjustAuxOneOnTime(inc) {
  if (auxRelayOneMode == 0) {
	...
	document.getElementById("auxRelayOneOnTime").innerHTML = onTime;
  }
}
...
function adjustAuxOneOffTime(inc) {
  if (auxRelayOneMode == 0) {
	...
	document.getElementById("auxRelayOneOffTime").innerHTML = offTime;
  }
}
...
function adjustLightState(state) {
  lightState = state;
  if (lightState == 0) {
    document.getElementById("lightOn").style.backgroundColor = "lightgrey";
    document.getElementById("lightAuto").style.backgroundColor = "lime";
  ...
  setVal("lightState", lightState);
}

function adjustAuxOneState(state) {
  auxRelayOneState = state;
  if (auxRelayOneState == 0) {
    document.getElementById("auxOneOn").style.backgroundColor = "lightgrey";
    document.getElementById("auxOneAuto").style.backgroundColor = "lime";
    document.getElementById("auxOneOff").style.backgroundColor = "lightgrey";
  ...
  setVal("auxOneState", auxRelayOneState);
}

function adjustAuxTwoState(state) {
  auxRelayTwoState = state;
  if (auxRelayTwoState == 0) {
    document.getElementById("auxTwoOn").style.backgroundColor = "lightgrey";
    document.getElementById("auxTwoAuto").style.backgroundColor = "lime";
    document.getElementById("auxTwoOff").style.backgroundColor = "lightgrey";
  ...
  setVal("auxTwoState", auxRelayTwoState);
}
...
function adjustAuxOneMode(mode) {
  auxRelayOneMode = mode;
  setToggleButton(auxRelayOneMode,"auxOneMode");      
  if (auxRelayOneMode == 0) {
	document.getElementById("auxRelayOneOnHrs").style.display = "inline";
	document.getElementById("auxRelayOneOnTime2").style.display = "inline";
	document.getElementById("auxRelayOneOnMins").style.display = "inline";
  ...
  adjustAuxOneOnTime(null);
  adjustAuxOneOffTime(null);
  setVal("auxRelayOneMode", auxRelayOneMode);
}

function adjustAuxTwoMode(mode) {
  auxRelayTwoMode = mode;
  setToggleButton(auxRelayTwoMode,"auxTwoMode");      
  if (auxRelayTwoMode == 0) {
	document.getElementById("auxRelayTwoOnHrs").style.display = "inline";
	document.getElementById("auxRelayTwoOnTime2").style.display = "inline";
	document.getElementById("auxRelayTwoOnMins").style.display = "inline";
  ...
  adjustAuxTwoOnTime(null);
  adjustAuxTwoOffTime(null);
  setVal("auxRelayTwoMode", auxRelayTwoMode);
}
...
function adjustValue(inc, v, min, max, pre, cmd) {
  if (inc != null) {
    ...
    console.log("inc = " + inc + ", adjustment = " + parseFloat(v).toFixed(pre));
  }
  else {
	 console.log("adjustment is null, for value: " + parseFloat(v).toFixed(pre));
  }
  return v;
}
...
function adjustLightOnTimer(inc, minute, hour) {
  minute = parseInt(minute);
  hour = parseInt(hour);
  if (inc < 0) {
    if (minute >= 15) minute-=15;
...
function adjustLightOffTimer(inc, minute, hour) {
  minute = parseInt(minute);
  hour = parseInt(hour);
  if (inc < 0) {
    if (minute >= 15) minute-=15;
...
function adjustAuxRelayOneOnTimer(inc, minute, hour) {
  minute = parseInt(minute);
  hour = parseInt(hour);
  if (inc < 0) {
    if (minute >= 15) minute-=15;
...
function adjustAuxRelayOneOffTimer(inc, minute, hour) {
  minute = parseInt(minute);
  hour = parseInt(hour);
  if (inc < 0) {
    if (minute >= 15) minute-=15;
...
function adjustAuxRelayTwoOnTimer(inc, minute, hour) {
  minute = parseInt(minute);
  hour = parseInt(hour);
  if (inc < 0) {
    if (minute >= 15) minute-=15;
...
function adjustAuxRelayTwoOffTimer(inc, minute, hour) {
  minute = parseInt(minute);
  hour = parseInt(hour);
  if (inc < 0) {
    if (minute >= 15) minute-=15;
		...
		if (this.readyState == 4 && this.status == 200) {
		  ...
		  ///////////////////////////////////////////////////////////////////
			...
			if (valLen == 13) {		 
			  ...
			  console.log("Settings page: error expected 13, received " + valLen);
		  }
		  ///////////////////////////////////////////////////////////////////
		  else if (pageNumber == 6) {
			if (valLen == 5) {	
		  ...
		  ///////////////////////////////////////////////////////////////////
			...
			if (valLen == 24) {		       
				lightOnTimeHour = values[cnt++];
				lightOnTimeMin = values[cnt++];
				lightOffTimeHour = values[cnt++];
				lightOffTimeMin = values[cnt++];
				lightOnDuration = values[cnt++];
				lightOffDuration = values[cnt++];
				lightState = values[cnt++];
				lightMode = values[cnt++];
				auxRelayOneOnTimeHour = values[cnt++];
				auxRelayOneOnTimeMin = values[cnt++];
				auxRelayOneOffTimeHour = values[cnt++];
				auxRelayOneOffTimeMin = values[cnt++];
				auxRelayOneOnDuration = values[cnt++];
				auxRelayOneOffDuration = values[cnt++];
				auxRelayOneState = values[cnt++];
				auxRelayOneMode = values[cnt++];
				auxRelayTwoOnTimeHour = values[cnt++];
				auxRelayTwoOnTimeMin = values[cnt++];
				auxRelayTwoOffTimeHour = values[cnt++];
				auxRelayTwoOffTimeMin = values[cnt++];
				auxRelayTwoOnDuration = values[cnt++];
				auxRelayTwoOffDuration = values[cnt++];
				auxRelayTwoState = values[cnt++];
