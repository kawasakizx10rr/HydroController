/*
  Version V4.9.3 Updated on the 10th Mar 2024
*/
// device::settingsAdjusted <-- remove or use to show a save adjustments dialog ?
// water height as float ?
// send wifi name, password and disable wifi to esp
// webpage needs day night air values
