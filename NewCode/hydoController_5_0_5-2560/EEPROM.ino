...
uint32_t getSetSystemEEPROM(const device::eepromModes a_mode) {
  ...
  eepromGetSet(address, a_mode, sensor::phPotStep);  
  eepromGetSet(address, a_mode, sensor::phVoltagePerUnit);
  eepromGetSet(address, a_mode, sensor::ph4Voltage);
  eepromGetSet(address, a_mode, sensor::ph7Voltage);
  //
